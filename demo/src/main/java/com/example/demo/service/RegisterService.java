...
public class RegisterService {
    ...
    public String register(@NotNull SignupRequest request) throws IOException, MessagingException, ParseException {
        ...
        if (currentYear < 6){
            throw new ApiRequestException("Age must not be less than 6!! ");
        }
        ...
        if (strRoles != null){
            if (strRoles.contains("ROLE_MODERATOR") || (strRoles.contains("ROLE_ADMIN"))){
                return "Success";
            }
        ...
        emailSender.send(
                request.getEmail(),"Confirm register",
